(function () {
  ...
  function renderCustomerOrderTables() {
    ...
    }).join('') || '<tr><td colspan="8" style="color:var(--steel-500); text-align:center; padding:26px;">No orders currently in production</td></tr>';
    ...
    }).join('') || '<tr><td colspan="8" style="color:var(--steel-500); text-align:center; padding:26px;">No order history yet</td></tr>';
  }
  ...
  function renderOrdersTable() {
    ...
    }).join('') || '<tr><td colspan="9" style="color:var(--steel-500); text-align:center; padding:26px;">' + (orderCustFilter === 'all' ? 'You have no orders yet' : 'No orders for this customer') + '</td></tr>';
  ...
  function renderCustomersTable() {
    ...
    }).join('') || '<tr><td colspan="4" style="color:var(--steel-500); text-align:center; padding:26px;">You have no customer accounts yet</td></tr>';
